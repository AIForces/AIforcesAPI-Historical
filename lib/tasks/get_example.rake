...
namespace :get_example do
  ...
  task event: :environment do
    Git.clone('https://github.com/aalekseevx/tron_event.git', 'storage/events/tron_event_temp')
    FileUtils.mv('storage/events/tron_event_temp', 'storage/events/tron_event')
